...
class ImageTransformer(object):
    ...
    def __init__(self, image, shape):
        self.image = resize_image(image, shape)
    ...
    def rotate_along_axis(self, theta=0, phi=0, gamma=0, dx=0, dy=0, dz=0):
        ...
        return cv2.warpPerspective(self.image.copy(), mat, (self.height, self.width),borderMode=cv2.BORDER_CONSTANT,borderValue=(255,255,255))
